export const QUESTIONS_AND_ANSWERS = [
  ...
  {
    question: 'How secure is my data with Levofron?',
    answer:
      "Levofron requires only read-only access to the user's Notion database and all user-provided security keys are encrypted. The security of its users' data is a top priority for Levofron.",
  },
  {
    question: 'How can I get started with Levofron?',
    answer:
  ...
  {
    question: 'Is Levofron free to use?',
    answer:
      'Yes, Levofron is completely free to use and support is provided through donations. Donations can be made through Buy-Me-A-Coffee or PayPal.How can I remove my Levofron account?',
  },
  {
    question: 'How can I remove my Levofron account?',
    answer:
